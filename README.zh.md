...
<p align="center">
  ...
  <a href="https://github.com/qyfanshen/zhizao.qyfanshen"><img src="https://img.shields.io/github/stars/qyfanshen/zhizao.qyfanshen?style=social" alt="Stars"></a>
</p>
...
- **🏭 车间总览** — 实时产值、合格率与设备 OEE 监控。
- **📋 工单跟踪** — 跨车间在制工单进度跟踪。
- **👥 管理端与员工端** — 商会管理端与会员员工端分离视图。
